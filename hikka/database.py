    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                self._client,
                "vanda-assets",
                "🌆 Your VANDA assets will be stored here",
                archive=True,
                avatar="https://i.postimg.cc/L5xHk6pS/vanda-assets.png"
            )
            
            # Отправляем приветственную картинку в канал
            await self._client.send_file(
                self._assets,
                "https://i.pinimg.com/736x/77/e3/81/77e381bcedfc3fbffe44c93b01e39c47.jpg",
                caption="🌆 Your VANDA assets are ready!"
            )
