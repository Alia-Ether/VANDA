...
class CoreMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                ...
                False,
                (
                    "Allow @FrontendVSCode.t.me to control the actions of your userbot"
    ...
    @loader.command(alias="hikka", ru_doc="Информация о Хероку", en_doc="Information of VANDA", ua_doc="Інформація про Хероку", de_doc="Informationen über VANDA")
    async def vandacmd(self, message: Message):
