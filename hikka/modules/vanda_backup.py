...
@loader.tds
class VANDABackupMod(loader.Module):
    """Handles database and modules backups"""

    strings = {"name": "VANDABackup"}

    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://i.pinimg.com/736x/e3/e4/3d/e3e43d408313349bf05f2821fc09cd80.jpg",
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://i.postimg.cc/kgB5c8D9/vanda-backups.png",
            _folder="vanda",
            invite_bot=True,
        )
    ...
    async def handler(self):
        try:
            ...
            backup.name = (
                f"vanda-db-backup-{datetime.datetime.now():%d-%m-%Y-%H-%M}.json"
            )
            ...
            logger.exception("VANDABackup failed")
