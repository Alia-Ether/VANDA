...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " VANDA will try to determine, which client caused logs. E.g. there"
                    ...
                    " VANDA will send all logs to Client1 and Client2, even if it is"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/Alia-Ether/VANDA/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "vanda-logs",
            "🐧 Your VANDA logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar="https://i.postimg.cc/cChJDBfP/vanda-logs.png",
        )
