...
@loader.tds
class vandaInfoMod(loader.Module):
    """Show userbot info"""

    strings = {"name": "VANDAInfo"}
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://i.pinimg.com/736x/66/10/1f/66101fc11c0aa76c8a0c4366005890a5.jpg",
                ...
                *map(
                    ...
                    (
                        (
                            ...
                            if self._client.hikka_me.premium and self.config["show_vanda"]
                            else ""
                        ),
    ...
    async def upload_pp_to_oxo(self, photo):
        ...
        try:
            ...
            if oxo.status_code == 200:
                ...
                return "https://i.pinimg.com/736x/66/10/1f/66101fc11c0aa76c8a0c4366005890a5.jpg"
    ...
    @loader.command()
    async def vandainfo(self, message: Message):
