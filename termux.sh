...
eval "cat ~/VANDA/assets/download.txt"
printf "\n\n\033[1;35mVANDA is being installed... ✨\033[0m"
...
eval "cd && git clone https://github.com/Alia-Ether/VANDA && cd VANDA"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && cd ~/VANDA && python3 -m hikka' > ~/.bash_profile"
